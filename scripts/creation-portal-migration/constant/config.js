...
const CONFIG = {
  ...
  APIS: {
    ...
    create_questionset: process.env.CREATE_QUESTIONSET || "api/questionset/v1/create",
    update_hierarchy: process.env.UPDATE_HIERARCHY || "api/questionset/v1/hierarchy/update",
    publish_questionset: process.env.PUBLISH_QUESTIONSET || "api/questionset/v1/publish",
    read_questionset: process.env.READ_QUESTIONSET || "api/questionset/v1/hierarchy/",
