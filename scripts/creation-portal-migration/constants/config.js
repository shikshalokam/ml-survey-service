...
const CONFIG = {
    ...
    HOST: {
        ...
        creation_portal: process.env.CREATION_PORTAL_BASE_URL || "https://dock.sunbirded.org/",
    },
    ...
    APIS: {
        ...
        read_questionset: process.env.READ_QUESTION_SET || "api/questionset/v1/hierarchy/read",
