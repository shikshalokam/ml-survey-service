...
module.exports = class Surveys extends Abstract {
    ...
    */
    ...
    getDetailsByLink(req) {
     ...
     /**
    * @api {post} /assessment/api/v1/surveys/details/:surveyId?solutionId=:solutionId 
    * Survey details.
    * @apiVersion 3.0.0
    * @apiGroup Surveys
    * @apiHeader {String} X-authenticated-user-token Authenticity token
    * @apiSampleRequest /assessment/api/v1/surveys/details/5de8a220c210d4700813e695?solutionId=5f5b38ec45365677f64b2843
    * @apiParamExample {json}  Request-Body:
    * {
    *   "role" : "HM",
        "state" : "236f5cff-c9af-4366-b0b6-253a1789766a",
